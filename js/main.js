...
const colButtonRight = document.querySelector('.fa-chevron-right-hidden')
...
document.querySelector('.collapse-button').onclick = function () {
    ...
    colButtonLeft.classList.toggle('fa-chevron-left-hidden')
    colButtonRight.classList.toggle('fa-chevron-right')
}